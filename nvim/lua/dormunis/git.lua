local function get_conflict_range()
  ...
  if not sep_line or not end_line then
    return nil
  end
...
end, { desc = "Conflict: accept ours" })
vim.keymap.set("n", "<leader>ct", function()
  resolve_conflict("theirs")
end, { desc = "Conflict: accept theirs" })
vim.keymap.set("n", "<leader>cb", function()
  resolve_conflict("both")
end, { desc = "Conflict: accept both" })
